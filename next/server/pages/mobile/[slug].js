...
const query = next_sanity__WEBPACK_IMPORTED_MODULE_2__.groq`*[_type == "mobile" && slug.current == $slug][0]`;
const getStaticPaths = async ()=>{
    const paths = await _lib_client__WEBPACK_IMPORTED_MODULE_3__/* .client.fetch */ .L.fetch(next_sanity__WEBPACK_IMPORTED_MODULE_2__.groq`*[_type == "mobile" && defined(slug.current)][]{
...
const getStaticProps = async ({ params  })=>{
    ...
    const mobile = await _lib_client__WEBPACK_IMPORTED_MODULE_3__/* .client.fetch */ .L.fetch(query, queryParams);
    return {
        props: {
            mobile
        }
...
var __webpack_exports__ = __webpack_require__.X(0, [636,675,664,296,233,783,353,844,186,894], () => (__webpack_exec__(9080)));
